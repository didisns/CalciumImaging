...
[~,~,excel] = xlsread('L:\Data to be analyzed\Calcium imaging\13-02-2019 animal 2\lfp022.xlsx'); % fill out the name 
greennumber = 1; % fill out the number of green ROIs, make sure they are second in the excel file
greenROIarea = [133]; % fill out the area's of the green ROIs measured in imagej ROI manager
redROIarea = [177]; % fill out the area's of the red ROIs measured in imagej ROI manager
...
LFPstartgalvo =  3.1055; % indicate the start time you obtained in the eventdetection tab 'save start imaging'
LFPstopgalvo =  189.3385; % indicate the stop time you obtained in the eventdetection tab 'save start imaging'
load('L:\Data to be analyzed\Calcium imaging\13-02-2019 animal 2\UStable_13-02-2019 animal 2_lfp_0022.abf.mat');
