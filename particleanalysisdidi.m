...
for gr = 1:greennumber
    ...
    if isempty (timegreen)
        ...
        if timegreen(1) == 1
            ...
            savei(countgreen(gr)) = 1; % needed to determine the end time in the next loop
            starttransients_green(countgreen(gr)) = 0;
        end
...
for rr = 1:rednumber
    ...
    if isempty (timered)
        ...
        if timered(1) == 1
            ...
            savei(countred(rr)) = 1; % needed to determine the end time in the next loop
            starttransients_red(countred(rr)) = 0;
        end
        ...
        % then the end of the last transient is the last value of timered
